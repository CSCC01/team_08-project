"""
Django settings for SDServer project.
...
SECRET_KEY = 'e__kj=#ny0vab4e2*&kj7=d@0cq1v%9@$uk407b)6(%x3-h3ip'
...
WSGI_APPLICATION = 'SDServer.wsgi.application'
